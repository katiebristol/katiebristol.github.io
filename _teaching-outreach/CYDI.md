...
<div class="row justify-content-sm-center align-items-stretch">
    <div class="col-sm-3 mt-3 mt-md-0 d-flex flex-column">
        {% include figure.liquid path="assets/img/teaching-outreach/FLmuseum.png" title="FL Museum" class="img-fluid rounded z-depth-1 w-100 h-100 style-cover" %}
    </div>
    <div class="col-sm-3 mt-3 mt-md-0 d-flex flex-column">
        {% include figure.liquid path="assets/img/teaching-outreach/chemours.png" title="Chemours" class="img-fluid rounded z-depth-1 w-100 h-100 style-cover" %}
    </div>
    <div class="col-sm-3 mt-3 mt-md-0 d-flex flex-column">
        {% include figure.liquid path="assets/img/teaching-outreach/UFgeo.png" title="UF Geological Sciences" class="img-fluid rounded z-depth-1 w-100 h-100 style-cover" %}
    </div>
</div>

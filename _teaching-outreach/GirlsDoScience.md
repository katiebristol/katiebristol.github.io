...
<div class="row justify-content-center">
    <div class="col-md-7 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/teaching-outreach/cydi-rockchoc.jpg" title="Rock or Choc" caption="Photo by Kimberly Blum (WUFT/NPR/PBS)" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

...
img: assets/img/arizona/arizona1.jpg
importance: 1
category: fun
---

<div class="gallery">
  {% for image in site.data.arizona %}
    <div class="gallery-item">
      <a href="{{ '/assets/img/arizona/' | append: image.url | relative_url }}" 
         class="gallery-item glightbox" 
         data-title="{{ image.title }}" 
         data-description="{{ image.caption }}">
        <img src="{{ '/assets/img/arizona/' | append: image.url | relative_url }}" alt="{{ image.title }}">
      </a>
    </div>
  {% endfor %}
</div>

...
<div class="gallery">
  {% for image in site.data.india %}
    <div class="gallery-item">
      <a href="{{ '/assets/img/india/' | append: image.url | relative_url }}" 
         class="gallery-item glightbox" 
         data-title="{{ image.title }}" 
         data-description="{{ image.caption }}">
        <img src="{{ '/assets/img/india/' | append: image.url | relative_url }}" alt="{{ image.title }}">
      </a>
    </div>
  {% endfor %}
</div>

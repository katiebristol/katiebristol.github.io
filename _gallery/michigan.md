...
img: assets/img/michigan/michigan001.jpg
importance: 1
category: fun
---

<div class="gallery">
  {% for image in site.data.michigan %}
    <div class="gallery-item">
      <a href="{{ '/assets/img/michigan/' | append: image.url | relative_url }}" 
         class="gallery-item glightbox" 
         data-title="{{ image.title }}" 
         data-description="{{ image.caption }}">
        <img src="{{ '/assets/img/michigan/' | append: image.url | relative_url }}" alt="{{ image.title }}">
      </a>
    </div>
  {% endfor %}
</div>
